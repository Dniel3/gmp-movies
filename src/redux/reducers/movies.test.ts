import { FAKE_MOVIE } from '../../components/moremenu/MoreMenu.test';
import {
  error, listMovies, MoviesActions, selectMovie, startLoading,
} from '../actions';
import moviesReducer, { INITIAL_STATE } from './movies';

describe('MovieReducer', () => {
  it('should return initial state', () => {
    expect(moviesReducer(undefined, { type: MoviesActions.UNKNOWN, payload: {} }))
      .toBe(INITIAL_STATE);
  });
